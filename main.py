...
class Console:
    def title():
        while Stats.working:
            ...
            ctypes.windll.kernel32.SetConsoleTitleW(f'Kahoot Flooder | Success: {Stats.flooded} - Failed: {Stats.failed} - Elapsed: {elapsed_days}d {elapsed_hours}h {elapsed_minutes}m {elapsed_seconds}s | By isadami')
...
░▒█░   ░██████▒░ ████▓▒░░ ████▓▒░░▒████▓ ░▒████▒░██▓ ▒██▒
 ...
 ░ ░     ░ ░   ░ ░ ░ ▒  ░ ░ ░ ▒   ░ ░  ░    ░     ░░   ░ 
        ...
        kahoot_id = input(f"{Output.gray} {KahootFlooder.__time__("")} {Output.reset}[{Output.cherry}?{Output.reset}] {Output.gray}Kahoot Game PIN: {Output.light_cyan}"); print()
